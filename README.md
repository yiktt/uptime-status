...
<img width="1152" alt="image" src="https://cdn.jsdelivr.net/gh/yiktt/cdn/picture/1e1top/22825/20220825160733.png">
...
- 下载并解压缩：[uptime-status.zip](https://github.com/yiktt/uptime-status/archive/refs/tags/V2.0.zip "uptime-status.zip") 
- 修改 `config.js` 文件：
   - `SiteName`: 要显示的网站名称
